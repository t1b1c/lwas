...
namespace LWAS.CustomControls
{
	public class Paginater : Panel, INamingContainer
	{
		...
		private OneClickButton firstButton;
		private OneClickButton backwardButton;
		private OneClickButton forwardButton;
		private OneClickButton lastButton;
		...
		protected override void OnInit(EventArgs e)
		{
            ...
            table.CssClass = "paginater-table";
			...
			tableRow.Controls.Add(tableCell);
			tableCell = new TableCell();
			this.forwardButton = new OneClickButton();
			this.forwardButton.CommandName = "paginater:right";
			this.forwardButton.Click += new EventHandler(this.forwardButton_Click);
			tableCell.Controls.Add(this.forwardButton);
			tableRow.Controls.Add(tableCell);
			tableCell = new TableCell();
			this.lastButton = new OneClickButton();
			this.lastButton.CommandName = "paginater:last";
