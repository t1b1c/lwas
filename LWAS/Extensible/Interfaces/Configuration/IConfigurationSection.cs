...
{
	public interface IConfigurationSection : IConfigurationType, IXmlSerializable
	{
		...
		IConfigurationElementAttribute GetAttributeReference(string element, string attribute);
	}
}
